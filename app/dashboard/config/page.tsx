  ...
  return (
    <div className="p-8 max-w-3xl">
      <div className="mb-8">
        ...
        <p className="text-slate-500 mt-1">Ajustes generales de producción y precios</p>
      </div>

      <div className="bg-white rounded-3xl border border-slate-200/70 shadow-sm p-8 space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                className="w-full mt-2 border border-slate-200 rounded-2xl px-4 py-3 text-lg focus:outline-none focus:ring-2 focus:ring-brand-primary/20 focus:border-brand-primary transition"
              />
        ...
        <div>
          <h3 className="font-semibold text-lg mb-5 text-slate-800 flex items-center gap-2">
            <span className="w-8 h-8 bg-emerald-50 rounded-xl flex items-center justify-center text-emerald-600 font-bold text-sm">
              L.
            </span>
            Precios de Venta
          </h3>
            ...
            <div>
              ...
              <div className="relative mt-2">
                ...
                <input
                  ...
                  className="w-full pl-10 border border-slate-200 rounded-2xl px-4 py-3 text-lg focus:outline-none focus:ring-2 focus:ring-brand-primary/20 focus:border-brand-primary transition"
                />
              </div>
            </div>
            <div>
        ...
        <button
          ...
          disabled={guardando}
          className="w-full flex items-center justify-center gap-3 bg-brand-primary hover:bg-brand-primary-dark disabled:opacity-70 text-white py-4 rounded-2xl font-semibold text-lg transition-colors shadow-sm shadow-brand-primary/25"
        >
          {guardando ? (
